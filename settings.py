...
def welcomemessage(chat_id, action):
    groups_collection.update_one({'id':str(chat_id)}, {'$set':{'general.welcome':f'{action}'}})
...
def add_entry(chat_id):
    to_add = {
        ...
        'general':{'clean_mode':'off',
                   ...
                   'welcome':'on',
                   'welcome_message':'Hey [NAME], Welcome to [GROUPNAME], Enjoy your stay'
        },
        'play': {'max_results':5},
