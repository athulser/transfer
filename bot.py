                ...
                if i['id'] == str(userID):
                    ...
                    if images_generated >= 2 and isSubscriber(userID) == 0:
                        ...
                        if response == 'err':
                            ...
                            bot.send_message(message.chat.id, "AI Model is facing high traffic at this moment. Will be recovered in 0-2 hours")
                        else:
                            response['created']
