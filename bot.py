...
def play_command(message):
    ...
    if len(query) == 0:
        ...
        if 'movie' in query.lower() or 'cinema' in query.lower() or 'film' in query.lower() or 'full movie' in query.lower() or '2023' in query.lower():
            ...
            global filename
            filename = f'{query.replace(" ", "")}{str(randomNumber())}'
...
def callback_query_handler(call):
    if call.data.startswith('hehe'):
        ...
        filenamevideo = f'video{str(randomNumber())}'
        ...
        ydl_optsvideolow = {
            "format":"worstvideo[ext=mp4]+worstaudio[ext=mp3]/worst",
            "outtmpl":filenamevideolow+'.mp4',
            "quiet":True,
        }
