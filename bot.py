...
def no(message):
    bot.send_message(chat_id=message.chat.id, reply_to_message_id=message.message_id, text='ɪɴ ɢʀᴏᴜᴘꜱ ʏᴏᴜ ᴄᴀɴ ꜱɪᴍᴘʟʏ ᴊᴜꜱᴛ ꜱᴇɴᴛ ᴛʜᴇ ᴜʀʟ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ.')
            ...
            if not isIgLink(query):
                ...
                if query.startswith('https://www.instagram.com/reel/') or query.startswith('https://instagram.com/reel/'):
                    ...
                    if len(photos) == 0:
                        ...
                        bot.delete_message(userID, _message.message_id)
                        for i in photos:
                            bot.send_photo(userID, photo=i, caption=caption, parse_mode="Markdown")
