...
def start_message(message):
    ...
    if not res:
        towrite = {'id':str(userID), "credits":3, "joinedOn":datetime.datetime.now().timestamp()}
...
def callback_query_handler(call):
    if call.data.startswith('hehe'):
        ...
        msg = f'*━━━━━━ TOPUP ━━━━━━*\n\n*Topup from the list below, send the screenshot of proof* [here](https://t.me/ieatkidsforlunch) *for the redeem code.*\n\n*Use this code as* "`/topup Yourcode`" *to redeem your credits.*\n\nHere is the topup plans for credits:\n\n*3 Credits            :   ₹90* ([Pay here](https://google.com))\n\n*7 Credits            :   ₹210* ([Pay here](https://google.com))\n\n*16 Credits          :   ₹450* ([Pay here](https://google.com))\n\n*30 Credits         :   ₹750* ([Pay here](https://google.com))\n\n*60 +5 Credits   :   ₹1450* ([Pay here](https://google.com))'
                ...
                if response == 'err':
                 ...
                 #    images = response['images']
                    try:
                     #    for image in images:
                         bot.delete_message(message.chat.id, _message.message_id)
                         bot.send_photo(_message.chat.id, response, caption="Generated by Morty AI")
