...
def account(message):
    if message.chat.type == 'private':
        userID = message.chat.id
        firstname = clean(message.chat.first_name)
        lastname = clean(message.chat.last_name)
        username = message.chat.username
        bio = clean(message.chat.bio)
        
    elif message.chat.type == 'group' or message.chat.type == 'supergroup':
        userID = message.from_user.id
        firstname = clean(message.from_user.first_name)
        lastname = clean(message.from_user.last_name)
