...
@bot.message_handler(chat_types=['group', 'supergroup'], content_types=['text'], text_startswith=['https://fb.watch'])
def facebook(message):
    bot.send_message(message.chat.id, "Facebook URL detected")
